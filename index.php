...
<html lang="en"><head>
    ...
    <meta name="description" content="We specialize in making Whiteboard Videos for any company. You'll can rely on our efficiency, technical competence plus the talents of our renowned, experienced team to make you a truly impressive Whiteboard Video.">
    ...
    <title>Whiteboard.Video|Home</title>
...
<body>
       ...
       <h1 class="text-center text-capitalize"><span class="huge">W</span>elcome to <span class="huge">W</span>hiteboard.<span class="huge">V</span>ideo</h1>
        <div class="row banner-video">
            <div class="col-lg-8">
                ...
                <h2 class="banner-text">Cool Explainer Videos, Whiteboard Sketch Videos, Animation too! </h2>
            </div>
    ...
    ?>
    <div class="h2 text-center"><a href="examples.php" title="More Examples">More Examples</a></div>
    ...
    <section class="container m-25">
        <h1 class="text-center">Why Choose <strong>Whiteboard</strong> Video?</h1>
        <div class="row">
            <div class="col-sm-6">
    ...
    <section class="examples">
        <div class="container">
            ...
            <blockquote>Fast paced, kinetic videos designed to stimulate the brain's of the viewers with imagry, sound, and voice. We always collaborate with our clients to create a scipt, storyboard, and custom drawings.</blockquote>
        </div>
    </section>
    <section class="background-hash">
        <div class="container-fluid">
            <h2 class="text-center">Custom <strong>Whiteboard Video</strong></h2>
            ...
            <div class="media">
                <div class="container">
                    <div class="media-body">
                        ...
                        <p> You can get yourself a professional whiteboard video from us and link it with all you website and media accounts. An increasing number of people are visiting websites and using web 2.0 therefore. </p>
                        <p>The internet has developed into a highly valuable platform to find millions who may take an active interest in your product or service.</p>
                    </div>
            ...
            <div class="media">
                <div class="container">
                    ...
                    <div class="media-body">
                        ...
                        <p><a href="tel:801-748-2281" title="Call Now!">Call us today </a>and let our personnel connect with you and provide enough ideas about how to go about preparing a stunning kind involving whiteboard video for ones business.</p>
                    </div>
                </div>
            </div>
        </div>
