    ...
    <section class="jumbotron">
        <div class="row banner-video">
            ...
            <div class="col-lg-4 contact">
                ...
                <img src="http://www.websitetalkingheads.com/images/video-production-winner.png" class="img-responsive best-design" alt="Best in Web Design-Video Production">
            </div>
        </div>
    </section>
    <?php 
        ...
        <div class="container">
            <div class="row best">
                ...
                <div class="col-md-4">
                    ...
                    <p>Static commercials with images together with block letters are becoming more and more dated and inconsequential. In this fast-paced country of online web videos, those that will utilize the advantages using a website video is a ones who definitely will win. For the popular generation of promotional professionals, this is actually where their forte lies. Creative content creation—primarily by using animated video. </p>
                </div>
                <div class="col-md-4">
                    <p>At Whiteboard.Video we specialise in creating animated videos for all purposes. You'll be able to count on our efficiency, technical competence and also the talents of our legendary experienced team to make a truly notable animation video for any business. You will find that our services really collaborative right from the start to completion of the video. </p>
                </div>
                <div class="col-md-4">
                    <p>Animated Video is effective in data visualization and marketing campaigns while staying true to the short and quick video making style of producing viral videos. Just look at our extensive brochure of companies and organizations that have used our unique animation style. You will want to talk to much of our trusted representatives and get a quote by calling <a href="tel:801-748-2281" title="Call Now">801-748-2281</a>. </p>
                </div>
            </div>
        </div>
    </section>
    ...
    <script>
        $( window ).load( function () {
            ...
            if ( $( document ).width() > 768 ) {
                $( '.banner-video' ).find( '.contact' ).padHeight();
            }
        } );
    </script>
</body>
